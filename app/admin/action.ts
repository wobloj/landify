...
import { updateSiteGlobalContent, updatePublishStatus } from "@/lib/supabase/data";
 ...
 * Publikuje stronę, ustawiając is_published na true.
...
export async function publishPageAction() {
  ...
  try {
    ...
    return { success: false, message: error.message || "Błąd publikacji strony." };
 ...
 * Ustawia stronę na "Under Construction", ustawiając is_published na false.
...
export async function unpublishPageAction() {
    ...
    try {
        ...
        return { success: false, message: error.message || "Błąd de-publikacji strony." };
